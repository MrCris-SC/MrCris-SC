...
Plataforma integral web + móvil para la gestión de servicios de internet. Permite administrar clientes, contratos, pagos y tickets de soporte de manera eficiente.
...
Aplicación PWA con autenticación de usuarios, soporte offline mediante Service Workers, interfaz responsiva y despliegue en AWS EC2. Ideal para entornos con conectividad limitada.
